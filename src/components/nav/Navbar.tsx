...
const Navbar = () => {
  return (
    <div className='bg-white md:py-5 md:px-36'>
         <div className='bg-[#F6F7F8] h-24 text-black  md:flex md:justify-between items-center px-5 font-[graphik] rounded-2xl cursor-pointer '>
         <p>QueEzzy</p>
